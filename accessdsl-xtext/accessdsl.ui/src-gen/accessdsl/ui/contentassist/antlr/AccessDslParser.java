...
* generated by Xtext
*/
package accessdsl.ui.contentassist.antlr;
...
public class AccessDslParser extends AbstractContentAssistParser {
	...
	@Override
	protected accessdsl.ui.contentassist.antlr.internal.InternalAccessDslParser createParser() {
		accessdsl.ui.contentassist.antlr.internal.InternalAccessDslParser result = new accessdsl.ui.contentassist.antlr.internal.InternalAccessDslParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getQueryAndTypeMappingAccess().getGroup(), "rule__QueryAndTypeMapping__Group__0");
					put(grammarAccess.getQueryAndTypeMappingAccess().getGroup_9(), "rule__QueryAndTypeMapping__Group_9__0");
					...
					put(grammarAccess.getQueryAndTypeMappingAccess().getQueryParametersAssignment_9_0(), "rule__QueryAndTypeMapping__QueryParametersAssignment_9_0");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			accessdsl.ui.contentassist.antlr.internal.InternalAccessDslParser typedParser = (accessdsl.ui.contentassist.antlr.internal.InternalAccessDslParser) parser;
